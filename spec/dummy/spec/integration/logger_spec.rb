...
describe 'ROM logger' do
  ...
  it 'sets up rails logger for all repositories' do
    pending 'this will be re-enabled once we have feature detection on adapters ' \
      'and in case of missing rails-log-subscriber support we will set logger to Rails.logger'
